pipeline {
  ...
  environment {
      ...
      sonar_url = 'http://172.31.0.177:9000/'
      sonar_username = 'admin'
      sonar_password = 'admin'
       nexusUrl = '172.31.0.177:8081'
   ...
   stage('git clone') {
         steps {
            ...
            git 'https://github.com/hareesh26/game-of-life.git'
        }
